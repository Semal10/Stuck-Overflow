...
<body>
        ...
        if($method=='POST'){
            ...
            if($showAlert){
                echo   '<div class="alert alert-success alert-dismissible fade show" role="alert">
                            <strong>Success!</strong> Your problem has been added! Please wait a while for community to respond.
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
        ...
        <div class="container">
            <h1 class="py-2">Start a Discussion</h1>
            <p class="lead">You are not Logged in. Login to Start A Discussion!</p>
        </div>
        ';
    }
